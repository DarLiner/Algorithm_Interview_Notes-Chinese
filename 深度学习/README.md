...
- [46. 迁移学习相关概念**](#46-迁移学习相关概念)
- [47. 迁移学习、多任务学习和领域自适应的区别*](#47-迁移学习多任务学习和领域自适应的区别)
- [48. 深度生成模型、受限玻尔兹曼机相关概念](#48-深度生成模型受限玻尔兹曼机相关概念)
...
- 迁移学习与多任务学习
    > [47. 多任务学习和迁移学习的区别*](#47-多任务学习和迁移学习的区别)
- 领域自适应
...
- ~~迁移学习的输入在每个任务上具有不同的意义（甚至不同的维度），但是输出在所有的任务上具有**相同的语义**；多任务学习则相反~~
- 这两种都可能是迁移学习或者多任务学习的结构


# 48. 深度生成模型、受限玻尔兹曼机相关概念
