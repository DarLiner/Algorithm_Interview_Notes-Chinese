...
- [32. 神经网络中的卷积，以及卷积的动机：稀疏交互、参数共享、等变表示（平移不变性）***](#32-神经网络中的卷积以及卷积的动机稀疏交互参数共享等变表示平移不变性)
...
- [35. 池化（Pooling）的意义***](#35-池化pooling的意义)
...
> 《深度学习》 8.2 神经网络优化中的挑战 & 10.11 优化长期依赖
...
# 32. 神经网络中的卷积，以及卷积的动机：稀疏交互、参数共享、等变表示（平移不变性）***
...
> 《深度学习》 9.3 池化 & 9.4 卷积与池化作为一种无限强的先验