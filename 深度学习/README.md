...
- [16. 信息熵、KL 散度（相对熵）与交叉熵**](#16-信息熵kl-散度相对熵与交叉熵)
...
- [28. SGD 以及学习率的选择方法、带动量的 SGD***](#28-sgd-以及学习率的选择方法带动量的-sgd)
    - [28.1. （批）随机梯度下降（SGD）与学习率](#281-批随机梯度下降sgd与学习率)
    - [28.2. 带动量的 SGD](#282-带动量的-sgd)
- [29. 自适应学习率算法：AdaGrad、RMSProp、Adam 等***](#29-自适应学习率算法adagradrmspropadam-等)
    - [29.1. AdaGrad](#291-adagrad)
    - [29.2. RMSProp](#292-rmsprop)
    - [29.3. Adam](#293-adam)
- [30. 基于二阶梯度的优化方法：牛顿法、共轭梯度、BFGS 等的做法*](#30-基于二阶梯度的优化方法牛顿法共轭梯度bfgs-等的做法)
- [31. 批标准化（Batch Normalization）的意义**](#31-批标准化batch-normalization的意义)
- [32. 神经网络中的卷积，以及卷积的动机：稀疏连接、参数共享、等变表示（平移不变性）***](#32-神经网络中的卷积以及卷积的动机稀疏连接参数共享等变表示平移不变性)
    - [32.1. 稀疏连接（sparse connectivity）](#321-稀疏连接sparse-connectivity)
...
- [33. 卷积中不同零填充的影响**](#33-卷积中不同零填充的影响)
- [34. 基本卷积的变体：反卷积、空洞卷积***](#34-基本卷积的变体反卷积空洞卷积)
    - [34.1. 转置卷积|反卷积（Transposed convolution）](#341-转置卷积反卷积transposed-convolution)
    - [34.2. 空洞卷积|扩张卷积（Dilated convolution）](#342-空洞卷积扩张卷积dilated-convolution)
- [35. 池化、池化（Pooling）的作用***](#35-池化池化pooling的作用)
...
- [43. 分布式表示的概念、应用，与符号表示（one-hot 表示）的区别***](#43-分布式表示的概念应用与符号表示one-hot-表示的区别)
    - [43.1. 什么是分布式表示？](#431-什么是分布式表示)
    - [43.2. 分布式表示为什么强大？——分布式表示与符号表示](#432-分布式表示为什么强大分布式表示与符号表示)
- [44. 如何理解维数灾难？***](#44-如何理解维数灾难)
- [45. 迁移学习相关概念：多任务学习、一次学习、零次学习、多模态学习**](#45-迁移学习相关概念多任务学习一次学习零次学习多模态学习)
- [46. 图模型|结构化概率模型相关概念*](#46-图模型结构化概率模型相关概念)
- [47. 深度生成模型、受限玻尔兹曼机（RBM）相关概念*](#47-深度生成模型受限玻尔兹曼机rbm相关概念)
- [48. 深度学习在图像、语音、NLP等领域的常见作法与基本模型**](#48-深度学习在图像语音nlp等领域的常见作法与基本模型)
    - [48.1. 计算机视觉（CV）](#481-计算机视觉cv)
    - [48.2. 语音识别](#482-语音识别)
    - [48.3. 自然语言处理](#483-自然语言处理)
...
# 32. 神经网络中的卷积，以及卷积的动机：稀疏连接、参数共享、等变表示（平移不变性）***
> 《深度学习》 9.2 动机
...
## 34.1. 转置卷积|反卷积（Transposed convolution）
...
## 34.2. 空洞卷积|扩张卷积（Dilated convolution）
...
# 38. RNN 更新方程（前向传播公式），包括 LSTM、GRU 等***
...
# 43. 分布式表示的概念、应用，与符号表示（one-hot 表示）的区别***
> 《深度学习》 15.4 分布式表示
...
# 45. 迁移学习相关概念：多任务学习、一次学习、零次学习、多模态学习**
...
# 47. 深度生成模型、受限玻尔兹曼机（RBM）相关概念*
> 《深度学习》 16.7.1 实例：受限玻尔兹曼机、20.1 玻尔兹曼机、20.2 受限玻尔兹曼机


# 48. 深度学习在图像、语音、NLP等领域的常见作法与基本模型**
> 《深度学习》 12 应用
