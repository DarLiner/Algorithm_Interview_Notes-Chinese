**深度学习实践**（[项目经验](../项目经验/README.md)）
---
- [为什么使用 CNN 代替 RNN](../项目经验/README.md#为什么使用-cnn-代替-rnn)
  - RNN 计算资源的成本
  - RNN/LSTM 的**梯度消失**问题
- 卷积神经网络
  - [常见的卷积结构](../项目经验/README.md#常见的卷积结构)
    - [转置卷积](../项目经验/README.md#转置卷积)、[空洞卷积](../项目经验/README.md#空洞卷积)
    - [门卷积](../项目经验/README.md#门卷积)
      - [门卷积是如何防止梯度消失的](../项目经验/README.md#门卷积是如何防止梯度消失的)
...
# 梯度下降法
> 基础数学/深度学习的核心/[梯度下降法](../基础数学/深度学习的核心.md#2-梯度下降法)
