...
- 【**输出层**】输出层对应一棵**哈夫曼树**，以词表中词作为叶子节点，各词的出现频率作为权重——共 `N` 个叶子节点，`N-1` 个非叶子节点
  <div align="center"><a href=""><img src="../assets/TIM截图20180806141616.png" height="400" /></a></div>
...
- 示例：求 `P("足球"|context("足球"))`
  <div align="center"><a href=""><img src="../assets/TIM截图20180806144052.png" height="400" /></a></div>
...
- 这里保留了【投影层】，但实际上只是一个恒等变换
  <div align="center"><a href=""><img src="../assets/TIM截图20180806151406.png" height="400" /></a></div>
...
- 因此，负采样算法实际上就是一个**带权采样**过程
  <div align="center"><a href=""><img src="../assets/TIM截图20180806161221.png" height="200" /></a></div>
...
- 引入的一个在区间 `[0,1]` 上的 `M` 等距切分，其中 `M >> N`
  <div align="center"><a href=""><img src="../assets/TIM截图20180806165750.png" height="" /></a></div>
...
- 类似带权采样的策略，用**查表**来代替计算
  <div align="center"><a href=""><img src="../assets/TIM截图20180806172158.png" height="" /></a></div>
- 具体计算公式如下
...
- FastText 是从 Word2Vec 的 CBOW 模型演化而来的；<br/>
  ...
  <div align="center"><a href=""><img src="../assets/TIM截图20180807094759.png" height="" /></a></div>
